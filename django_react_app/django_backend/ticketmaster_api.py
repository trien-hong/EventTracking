...
def getEventsDetails(eventId):
    ...
    if state == False:
        try:
            address = ticketmaster_response_json["_embedded"]["venues"][0]["address"]["line1"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["city"]["name"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["postalCode"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["country"]["countryCode"]
        except KeyError as e:
            address = "TBD"
    else:
        try:
            address = ticketmaster_response_json["_embedded"]["venues"][0]["address"]["line1"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["city"]["name"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["state"]["stateCode"] + " " + ticketmaster_response_json["_embedded"]["venues"][0]["postalCode"] + ", " + ticketmaster_response_json["_embedded"]["venues"][0]["country"]["countryCode"]
        except KeyError as e:
            address = "TBD"
