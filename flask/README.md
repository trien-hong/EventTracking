# NOTE:
This version (Flask) is also outdated. I suggest seeing/using the Django or Django with React.
...
Heroku is removing their free tier starting on November 28, 2022. The link above may or may not be working anymore.
